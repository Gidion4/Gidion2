...
export class DialogManager {
    ...
    async handleTurn(sessionId, userInput) {
        ...
        let reply = null;
        if (codexRes && codexRes.ok)
            reply = codexRes.output;
        else if (plannerRes && plannerRes.ok)
            reply = plannerRes.output;
        else
            reply = { text: "En saanut luotua vastausta." };
