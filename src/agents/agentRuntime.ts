...
import { AgentMemory, stmSet, stmClear, ltmSet } from "./agentMemory.js";
...
export function createAgentRuntime(agent: AgentIdentity, memory: AgentMemory) {
  return {
    agent,
    memory,

    // Suorita tehtävä sandboxissa
    async runTask(task: AgentTask): Promise<AgentExecutionResult> {
