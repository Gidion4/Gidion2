// ------------------------------------------------------------
// GIDION ULTRAHYBRID LEVEL 4 — SELF TEST RUNNER v5
// ------------------------------------------------------------
// Tässä versiossa korjattu Windows + ESM + ts-node polkuongelma:
//   - import() käyttää pathToFileURL()
//   - testit löytyvät varmasti
//   - toimii kaikissa hakemistoissa
// ------------------------------------------------------------
import fs from "fs";
