// ------------------------------------------------------------
// GIDION LEVEL 5 â€” REPAIR DASHBOARD DATA TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
//   - UI-kerros saa deterministisen, kÃ¤yttÃ¶valmiin datarakenteen
// ------------------------------------------------------------

import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { getRepairDashboardData } from "./systemRepairDashboardData.js";
...
async function runTests() {
  ...
  console.log("âœ” All RepairDashboardData tests passed.");
  process.exit(0);
}
