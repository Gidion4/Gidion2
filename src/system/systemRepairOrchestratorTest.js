// ------------------------------------------------------------
// GIDION LEVEL 5 — REPAIR ORCHESTRATOR TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
async function runTests() {
    ...
    assert(typeof report.repairExecution.allSuccessful === "boolean", "repairExecution.allSuccessful invalid");
    // --- Test 6: fullyRepaired on boolean ---
    assert(typeof report.fullyRepaired === "boolean", "fullyRepaired is not boolean");
    console.log("✔ All RepairOrchestrator tests passed.");
    process.exit(0);
}
// ------------------------------------------------------------
// CLI ENTRYPOINT (ESM)
