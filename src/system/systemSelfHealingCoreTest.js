// ------------------------------------------------------------
// GIDION LEVEL 4 — SELF HEALING CORE TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
async function runTests() {
    ...
    if (report.issues.length > 0) {
        for (const issue of report.issues) {
            ...
            assert(["low", "medium", "high"].includes(issue.severity), "issue.severity invalid");
    ...
    console.log("✔ All SelfHealingCore tests passed.");
    process.exit(0);
}
// ------------------------------------------------------------
// CLI ENTRYPOINT (ESM)
