// ------------------------------------------------------------
// GIDION LEVEL 4 — SELF HEALING ORCHESTRATOR TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
async function runTests() {
    ...
    assert(typeof report.healingPlan.requiresManualReview === "boolean", "healingPlan.requiresManualReview invalid");
    ...
    assert(typeof report.executionReport.allSuccessful === "boolean", "executionReport.allSuccessful invalid");
    // --- Test 7: fullyHealthy on boolean ---
    assert(typeof report.fullyHealthy === "boolean", "fullyHealthy is not boolean");
    console.log("✔ All SelfHealingOrchestrator tests passed.");
    process.exit(0);
}
// ------------------------------------------------------------
// CLI ENTRYPOINT (ESM)
