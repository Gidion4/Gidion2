// ------------------------------------------------------------
// GIDION LEVEL 4 — SYSTEM STATE EXPORTER TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
async function runTests() {
    ...
    assert(secondResult.success === false, "Exporter allowed overwriting an existing file");
    console.log("✔ All SystemStateExporter tests passed.");
    process.exit(0);
}
// ------------------------------------------------------------
// CLI ENTRYPOINT (ESM)
