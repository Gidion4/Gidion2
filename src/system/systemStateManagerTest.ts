...
import { saveState, loadState } from "./systemStateManager.js";
...
async function runTests() {
  ...
  // --- Test 4: Virheellinen polku hylÃ¤tÃ¤Ã¤n ---
  ...
  console.log("âœ” All SystemStateManager tests passed.");
  process.exit(0);
}
