// ------------------------------------------------------------
// GIDION UI v1 â€” CORE LAYOUT TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
// Testaa uiCoreLayout.ts -moduulin keskeiset toiminnot:
//   - getUICoreLayout palauttaa validin layout-olion
//   - style- ja layout-kentÃ¤t ovat olemassa ja oikeassa muodossa
...
import { getUICoreLayout } from "./uiCoreLayout.js";
...
async function runTests() {
  ...
  console.log("âœ” All UICoreLayout tests passed.");
  process.exit(0);
}
