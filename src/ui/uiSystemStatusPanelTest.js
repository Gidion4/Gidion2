// ------------------------------------------------------------
// GIDION UI v1 — SYSTEM STATUS PANEL TEST v1 (ESM-COMPATIBLE)
// ------------------------------------------------------------
...
import { buildSystemStatusPanel } from "./uiSystemStatusPanel.ts";
...
async function runTests() {
    ...
    assert(typeof panel.data.health.requiresManualReview === "boolean", "panel.data.health.requiresManualReview invalid");
    // selfHealing
    assert(typeof panel.data.selfHealing === "object", "panel.data.selfHealing invalid");
    assert(typeof panel.data.selfHealing.plannedActions === "number", "panel.data.selfHealing.plannedActions invalid");
    assert(typeof panel.data.selfHealing.executedDryRunActions === "number", "panel.data.selfHealing.executedDryRunActions invalid");
    assert(typeof panel.data.selfHealing.dryRunAllSuccessful === "boolean", "panel.data.selfHealing.dryRunAllSuccessful invalid");
    // repair
    ...
    console.log("✔ All UISystemStatusPanel tests passed.");
    process.exit(0);
}
// ------------------------------------------------------------
// CLI ENTRYPOINT (ESM)
